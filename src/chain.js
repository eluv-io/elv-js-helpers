/**
 * Passthrough for the `chain()` [Crocks](https://crocks.dev/) function (Copyright © 2016, Ian Hofmann-Hicks, ISC license)
 *
 ...
 * @example
 *
 * const chain = require('@eluvio/elv-js-helpers/chain')
