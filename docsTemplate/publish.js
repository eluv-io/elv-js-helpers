...
exports.publish = (data, opts) => {
  const templateFile = Path.resolve(opts.destination, '..', 'docsTemplate', 'index.pug')

  // copy static assets
  copyDir(Path.resolve(opts.destination, '..', 'docsTemplate', 'images'), Path.resolve(opts.destination, 'images'))
  copyDir(Path.resolve(opts.destination, '..', 'docsTemplate', 'js'), Path.resolve(opts.destination, 'js'))
  copyDir(Path.resolve(opts.destination, '..', 'docsTemplate', 'styles'), Path.resolve(opts.destination, 'styles'))
