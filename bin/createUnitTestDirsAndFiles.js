...
// const {newUnitTestFileText, prettify} = require('./processJSDocExample')
...
if (!sourceDir || !targetDir) {
  ...
  node createUnitTestDirsAndFiles.js srcDir targetDir
...
mirrorDirStructure(sourceDir,targetDir)

// const {createCount, problemCount, skipCount} = mirrorDirStructure(
//   SRC_DIR,
//   UNIT_TEST_SRC_DIR
// )
//
